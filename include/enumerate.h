...
class ConformationalEnumerator {
  public:
    ...
    vector<Domain*> add_growthpoint(
            ...
            int new_d_i,
            Domain* old_domain);
    void remove_growthpoint(Domain* old_domain);
  ...
  protected:
    ...
    void set_comp_growthpoint_domains(
            Domain* domain,
            Domain* bound_domain,
            VectorThree p_new);
    void set_mis_growthpoint_domains(
            Domain* domain,
            Domain* bound_domain,
            VectorThree p_new);
...
class StapleEnumerator {
  ...
  private:
    ...
    void recurse(int cur_num_staples, int staple_type_i, int cur_num_staples_i);
};
} // namespace enumerator
