...
/** Conserved topology recoil growth base class */
class CTRGRegrowthMCMovetype: virtual public CTRegrowthMCMovetype {
...
class CTRGScaffoldRegrowthMCMovetype: public CTRGRegrowthMCMovetype {
...
class CTRGJumpScaffoldRegrowthMCMovetype: public CTRGRegrowthMCMovetype {
