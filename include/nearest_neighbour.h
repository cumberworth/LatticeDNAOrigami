...
const unordered_map<string, double> NN_Enthalpy {{"AA/TT", -7.6},
                                                 {"TT/AA", -7.6},
                                                 {"AT/TA", -7.2},
                                                 {"TA/AT", -7.2},
                                                 {"CA/GT", -8.5},
...
const unordered_map<string, double> Stacking_Energy {{"AA/TT", -1.36},
                                                     {"TT/AA", -1.36},
                                                     {"AT/TA", -2.35},
                                                     {"TA/AT", -1.01},
                                                     {"CA/GT", -0.81},
...
const map<char, char> Complementary_Base_Pairs {{'A', 'T'},
                                                {'T', 'A'},
                                                {'G', 'C'},
                                                {'C', 'G'}};
