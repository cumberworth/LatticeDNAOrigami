 ...
 * system.
 */
class LinkerRegrowthMCMovetype: virtual public CTRegrowthMCMovetype {
  public:
    LinkerRegrowthMCMovetype(
            ...
            int num_transforms);
    LinkerRegrowthMCMovetype(const LinkerRegrowthMCMovetype&) = delete;
    LinkerRegrowthMCMovetype& operator=(const LinkerRegrowthMCMovetype&) =
            delete;
...
class ClusteredLinkerRegrowthMCMovetype:
  ...
  public:
    ClusteredLinkerRegrowthMCMovetype(
            ...
            int num_transforms);
    ClusteredLinkerRegrowthMCMovetype(
            const ClusteredLinkerRegrowthMCMovetype&) = delete;
    ClusteredLinkerRegrowthMCMovetype& operator=(
            const ClusteredLinkerRegrowthMCMovetype&) = delete;
...
class CTCBLinkerRegrowthMCMovetype:
  ...
  public:
    CTCBLinkerRegrowthMCMovetype(
            ...
            unsigned int max_linker_length,
            int num_transforms);
    CTCBLinkerRegrowthMCMovetype(const CTCBLinkerRegrowthMCMovetype&) = delete;
    CTCBLinkerRegrowthMCMovetype& operator=(
            const CTCBLinkerRegrowthMCMovetype&) = delete;
...
class CTCBClusteredLinkerRegrowthMCMovetype:
  ...
  public:
    CTCBClusteredLinkerRegrowthMCMovetype(
            ...
            int num_transforms);
    CTCBClusteredLinkerRegrowthMCMovetype(
            const CTCBClusteredLinkerRegrowthMCMovetype&) = delete;
    CTCBClusteredLinkerRegrowthMCMovetype& operator=(
            const CTCBClusteredLinkerRegrowthMCMovetype&) = delete;
    void reset_internal() override;
};
...
class CTRGLinkerRegrowthMCMovetype:
  ...
  public:
    CTRGLinkerRegrowthMCMovetype(
            ...
            unsigned int max_linker_length,
            int num_transforms);
    CTRGLinkerRegrowthMCMovetype(const CTRGLinkerRegrowthMCMovetype&) = delete;
    CTRGLinkerRegrowthMCMovetype& operator=(
            const CTRGLinkerRegrowthMCMovetype&) = delete;
