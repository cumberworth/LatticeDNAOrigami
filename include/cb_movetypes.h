...
class CBMCMovetype: virtual public RegrowthMCMovetype {
...
class CBStapleRegrowthMCMovetype: public CBMCMovetype {
  ...
  public:
    CBStapleRegrowthMCMovetype(
            ...
            SystemBiases& biases,
            InputParameters& params);
    CBStapleRegrowthMCMovetype(const CBStapleRegrowthMCMovetype&) = delete;
...
class CTCBJumpScaffoldRegrowthMCMovetype: public CTCBRegrowthMCMovetype {
