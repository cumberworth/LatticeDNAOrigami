...
function(CheckGitVersion)
  ...
  #  if(NOT EXISTS ${post_configure_dir}/version.hpp)
  #  file(COPY ${pre_configure_dir}/version.hpp
  ...
  # Only update the version.cpp if the hash has changed. This will prevent
  # us from rebuilding the project more than we need to.
  if(NOT ${GIT_HASH} STREQUAL ${GIT_HASH_CACHE} OR NOT EXISTS
                                                   ${post_configure_file})
    # Set che GIT_HASH_CACHE variable the next build won't have to regenerate
    # the source file.
...
function(CheckGitSetup)
  ...
  target_include_directories(git_version PUBLIC include)
