...
namespace domainContainer {
    ...
    bool HalfTurnDomain::check_junction_constraint(Domain& cd_j2,
            Domain& cd_j3, Domain& cd_j4, Domain& cd_k1, Domain& cd_k2) {
    ...
    bool ThreeQuarterTurnDomain::check_twist_constraint(VectorThree ndr, Domain& cd_2) {
        bool twist_constraint_obeyed {true};
    ...
    bool ThreeQuarterTurnDomain::check_kink_constraint(VectorThree ndr, Domain& cd_2) {
        bool kink_constraint_obeyed {true};
        if (ndr == -m_ore) {
            kink_constraint_obeyed = false;
        }
...
//        }
    ...
    bool ThreeQuarterTurnDomain::check_junction_constraint(Domain& cd_j2,
            Domain& cd_j3, Domain& cd_j4, Domain& cd_k1, Domain& cd_k2) {
